...
#    Updated: 2024/01/24 12:44:37 by acroue           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INCLUDES = includes/
SRC_DIR = srcs
SRC = ${addprefix ${SRC_DIR}/, push_swap.c parsing.c make_tab.c operators.c rotate.c check_rank.c sorting.c cost.c apply_cost.c cost_compare.c}
OBJ_DIR = obj
